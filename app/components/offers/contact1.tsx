...
export default function C() {
  ...
  return (
    <>
      <Box sx={{ m: 10 }}>
        <Typography level="h1">CONTRACT TO SELL XMR</Typography>
...
<Box sx={{m:1}}>
<Typography level="body-sm">XMR to sell</Typography>
<Typography level="title-sm">N/A XMR</Typography>
</Box>
<Box sx={{m:1}}>
<Typography level="body-sm">Amount to receive</Typography>
<Typography level="title-sm">10,000 USD</Typography>
</Box>
</Stack>
</Sheet>
