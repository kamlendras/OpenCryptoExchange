...
export const chats: ChatProps[] = [
  {
    ...
    messages: [
      ...
      {
        id: '2',
        content: 'I can accept UPI GPAY bro',
        timestamp: 'Just now',
        sender: users[0],
      },
      {
        ...
        timestamp: 'Just now',
        sender: users[0],
        content: 'I require one time KYC verification Aadhar or Driving licence photo works it helps me verify youre the rightful account holder',
      },
      {
        id: '4',
        timestamp: 'Just now',
        sender: users[0],
        content: 'If you dont agree to my terms just cancel trade.',
      },
  //     {
  //       id: '5',
