...
export default function C() {
  ...
  return (
    <>
      <Box sx={{ m: 10 }}>
        <Typography level="h1">OFFER TO SELL MONERO</Typography>
        <Sheet
          variant="soft"
                            ...
                            >
                              <div>
                                ...
                                >
                                  ...
                                  the Seller must complete the payment. The
        ...
        >
          <Grid container  spacing={2} sx={{ flexGrow: 1 }}>
            <Grid xs={6} md={6} lg={6} xl={6}>
              <Typography level="body-xs">I want to sell XMR  for</Typography>
              ...
              <Typography sx={{mt:1}} level="body-xs">
                Enter the amount you are looking to sell
              </Typography>
              ...
              <Link href="/offers/Sell/select/contact">
            ...
            <Grid xs={6} md={6} lg={6} xl={6}>
              <Sheet
                ...
                //  sx={{ p: 4 }}
              >
                <Typography level="body-xs"> Amount to sell </Typography>
        ...
        color="success">Low </Chip> 0.00011616 XMR ≈0 USD{" "}
          ...
          <Stepper sx={{ mt: 4 }}>
            ...
            >
              The Seller sends the payment to the Seller
            </Step>
            <Step
              orientation="vertical"
              indicator={<StepIndicator variant="outlined">5</StepIndicator>}
            >
              Contract is completed, the Seller receives the Monero
            </Step>
          </Stepper>
        </Sheet>
      </Box>
